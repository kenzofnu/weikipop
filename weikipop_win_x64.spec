...
a = Analysis(
    ...
    hiddenimports=['src.ocr.providers.glensv2', 'src.ocr.providers.owocr', 'src.ocr.providers.meikiocr', 'src.ocr.providers.screenai', 'soundcard', 'soundcard.mediafoundation', 'cffi', '_cffi_backend'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
